...
# -*- coding: utf-8 -*-
#
# Leverice documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'Leverice.tex', 'Leverice Documentation',
     'Demian', 'manual'),
]
...
man_pages = [
    (master_doc, 'leverice', 'Leverice Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Leverice', 'Leverice Documentation',
     author, 'Leverice', 'One line description of project.',
     'Miscellaneous'),
]
